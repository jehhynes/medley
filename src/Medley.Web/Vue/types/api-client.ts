...
export class ArticleChatApiClient {
    ...
    getConversations(articleId: string): Promise<ConversationListDto[]> {
        let url_ = this.baseUrl + "/api/articles/{articleId}/chat/conversations";
    ...
    protected processGetConversations(response: Response): Promise<ConversationListDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as ConversationListDto[];
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ConversationListDto[]>(null as any);
    }
    ...
    stopConversation(articleId: string, conversationId: string): Promise<void> {
        let url_ = this.baseUrl + "/api/articles/{articleId}/chat/conversations/{conversationId}/stop";
        if (articleId === undefined || articleId === null)
            throw new globalThis.Error("The parameter 'articleId' must be defined.");
        url_ = url_.replace("{articleId}", encodeURIComponent("" + articleId));
        if (conversationId === undefined || conversationId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processStopConversation(_response);
        });
    }

    protected processStopConversation(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ArticlesApiClient {
    ...
    assign(id: string, request: ArticleAssignRequest): Promise<UserSummaryDto> {
        let url_ = this.baseUrl + "/api/articles/{id}/assign";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAssign(response: Response): Promise<UserSummaryDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as UserSummaryDto;
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
    ...
    unassign(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/articles/{id}/unassign";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUnassign(_response);
        });
    }

    protected processUnassign(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
...
export class KnowledgeUnitsApiClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(skip?: number | undefined, take?: number | undefined): Promise<KnowledgeUnitDto[]> {
        let url_ = this.baseUrl + "/api/knowledge-units?";
        if (skip === null)
            throw new globalThis.Error("The parameter 'skip' cannot be null.");
        else if (skip !== undefined)
            url_ += "skip=" + encodeURIComponent("" + skip) + "&";
    ...
    protected processGetAll(response: Response): Promise<KnowledgeUnitDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    get(id: string): Promise<KnowledgeUnitDto> {
        let url_ = this.baseUrl + "/api/knowledge-units/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGet(response: Response): Promise<KnowledgeUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    deleteKnowledgeUnit(id: string): Promise<DeleteKnowledgeUnitResponse> {
        let url_ = this.baseUrl + "/api/knowledge-units/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteKnowledgeUnit(_response);
        });
    }

    protected processDeleteKnowledgeUnit(response: Response): Promise<DeleteKnowledgeUnitResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as DeleteKnowledgeUnitResponse;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
    ...
    protected processSearch(response: Response): Promise<KnowledgeUnitSearchResult[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as KnowledgeUnitSearchResult[];
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<KnowledgeUnitSearchResult[]>(null as any);
    }

    updateConfidence(id: string, request: UpdateKnowledgeUnitConfidenceRequest): Promise<KnowledgeUnitDto> {
        let url_ = this.baseUrl + "/api/knowledge-units/{id}/confidence";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdateConfidence(response: Response): Promise<KnowledgeUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TokenUsageApiClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getMetrics(): Promise<TokenUsageMetrics> {
        let url_ = this.baseUrl + "/api/token-usage/metrics";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetMetrics(response: Response): Promise<TokenUsageMetrics> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as TokenUsageMetrics;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
...
export class UsersApiClient {
    ...
    protected processGetAll(response: Response): Promise<UserSummaryDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export interface ArticleAssignRequest {
    userId: string;
}
...
export interface UpdateKnowledgeUnitConfidenceRequest {
    confidence?: ConfidenceLevel;
    confidenceComment?: string | null;
}

export interface DeleteKnowledgeUnitResponse {
    success?: boolean;
    message?: string | null;
}
...
export interface TokenUsageMetrics {
    ...
    allTimeByType?: TokensByType;
    last30DaysByType?: TokensByType;
    allTimeByService?: MetricItem[];
    last30DaysByService?: MetricItem[];
}
