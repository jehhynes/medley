...
import type { ArticleVersionDto, VersionType } from '@/types/generated/api-client';
...
/**
 * Return type for useArticleVersions composable
 */
 ...
 */
export function useArticleVersions(articleId: Ref<string | null | undefined>): UseArticleVersionsReturn {
  /**
