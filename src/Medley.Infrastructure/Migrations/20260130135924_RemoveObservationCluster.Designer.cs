...
namespace Medley.Infrastructure.Migrations
{
    ...
    [Migration("20260130135924_RemoveObservationCluster")]
    partial class RemoveObservationCluster
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medley.Domain.Entities.AiPrompt", b =>
                {
                    ...
                    b.Property<Guid?>("FragmentCategoryId")
                        .HasColumnType("uuid")
                        .HasColumnName("fragment_category_id");
                    ...
                    b.HasIndex("FragmentCategoryId")
                        .HasDatabaseName("ix_ai_prompts_fragment_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    ...
                    b.HasIndex("FragmentCategoryId")
                        .HasDatabaseName("ix_fragments_fragment_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.FragmentCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Medley.Domain.Entities.KnowledgeUnit", b =>
                {
                    ...
                    b.HasIndex("FragmentCategoryId")
                        .HasDatabaseName("ix_knowledge_units_fragment_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.KnowledgeUnit", b =>
                {
                    b.HasOne("Medley.Domain.Entities.FragmentCategory", "Category")
                        .WithMany()
                        .HasForeignKey("FragmentCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_knowledge_units_fragment_categories_fragment_category_id");
