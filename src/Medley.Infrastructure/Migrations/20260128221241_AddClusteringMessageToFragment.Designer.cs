...
namespace Medley.Infrastructure.Migrations
{
    ...
    [Migration("20260128221241_AddClusteringMessageToFragment")]
    partial class AddClusteringMessageToFragment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticleFragment", b =>
                {
                    ...
                    b.HasKey("ArticleId", "FragmentsId")
                        .HasName("pk_article_fragments");

                    b.HasIndex("FragmentsId")
                        .HasDatabaseName("ix_article_fragments_fragments_id");

                    b.ToTable("article_fragments", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    ...
                    b.Property<string>("ClusteringMessage")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("clustering_message");
                    ...
                    b.Property<Guid?>("RepresentativeFragmentId")
                        .HasColumnType("uuid")
                        .HasColumnName("representative_fragment_id");
                    ...
                    b.HasIndex("RepresentativeFragmentId")
                        .HasDatabaseName("ix_fragments_representative_fragment_id");
            ...
            modelBuilder.Entity("ArticleFragment", b =>
                {
                    b.HasOne("Medley.Domain.Entities.Article", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_article_fragments_articles_article_id");
                    ...
                    b.HasOne("Medley.Domain.Entities.Fragment", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_fragments_fragments_fragments_id");
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    ...
                    b.HasOne("Medley.Domain.Entities.Fragment", "RepresentativeFragment")
                        .WithMany()
                        .HasForeignKey("RepresentativeFragmentId")
                        .HasConstraintName("fk_fragments_fragments_representative_fragment_id");
                    ...
                    b.Navigation("RepresentativeFragment");
