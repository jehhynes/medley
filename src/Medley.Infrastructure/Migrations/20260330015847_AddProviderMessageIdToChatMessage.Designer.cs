...
namespace Medley.Infrastructure.Migrations
{
    ...
    [Migration("20260330015847_AddProviderMessageIdToChatMessage")]
    partial class AddProviderMessageIdToChatMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArticleKnowledgeUnit", b =>
                {
                    b.Property<Guid>("ArticlesId")
                        .HasColumnType("uuid")
                        .HasColumnName("articles_id");

                    b.Property<Guid>("KnowledgeUnitsId")
                        .HasColumnType("uuid")
                        .HasColumnName("knowledge_units_id");

                    b.HasKey("ArticlesId", "KnowledgeUnitsId")
                        .HasName("pk_article_knowledge_units");

                    b.HasIndex("KnowledgeUnitsId")
                        .HasDatabaseName("ix_article_knowledge_units_knowledge_units_id");

                    b.ToTable("article_knowledge_units", (string)null);
                });

            modelBuilder.Entity("ClusterFragment", b =>
                {
                    b.Property<Guid>("ClustersId")
                        .HasColumnType("uuid")
                        .HasColumnName("clusters_id");

                    b.Property<Guid>("FragmentsId")
                        .HasColumnType("uuid")
                        .HasColumnName("fragments_id");

                    b.HasKey("ClustersId", "FragmentsId")
                        .HasName("pk_cluster_fragment");

                    b.HasIndex("FragmentsId")
                        .HasDatabaseName("ix_cluster_fragment_fragments_id");

                    b.ToTable("cluster_fragment", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.AiModelCostParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("EmbeddingCostPerMillion")
                        .HasColumnType("numeric")
                        .HasColumnName("embedding_cost_per_million");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_model_cost_parameters");

                    b.HasIndex(new[] { "ModelName" }, "IX_AiModelCostParameter_ModelName")
                        .IsUnique()
                        .HasDatabaseName("ix_ai_model_cost_parameters_model_name");

                    b.ToTable("ai_model_cost_parameters", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.AiPrompt", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastSyncedWithCursor")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_synced_with_cursor");
                    ...
                    b.HasIndex("KnowledgeCategoryId")
                        .HasDatabaseName("ix_ai_prompts_knowledge_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Article", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastSyncedToZendeskAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_synced_to_zendesk_at");
                    ...
                    b.Property<string>("ZendeskArticleId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("zendesk_article_id");
                    ...
                    b.HasIndex("CurrentPlanId")
                        .IsUnique()
                        .HasDatabaseName("ix_articles_current_plan_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.ArticleReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_article_reviews");

                    b.HasIndex("ArticleId")
                        .HasDatabaseName("ix_article_reviews_article_id");

                    b.HasIndex("ReviewedById")
                        .HasDatabaseName("ix_article_reviews_reviewed_by_id");

                    b.ToTable("article_reviews", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProviderMessageId" }, "IX_ChatMessages_ProviderMessageId")
                        .HasDatabaseName("ix_chat_messages_provider_message_id");

                    b.ToTable("chat_messages", (string)null);
                });

            modelBuilder.Entity("Medley.Domain.Entities.Cluster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("ClusteringSessionId")
                        .HasColumnType("uuid")
                        .HasColumnName("clustering_session_id");
                    ...
                    b.Property<double?>("IntraClusterDistance")
                        .HasColumnType("double precision")
                        .HasColumnName("intra_cluster_distance");

                    b.HasKey("Id")
                        .HasName("pk_clusters");

                    b.HasIndex("ClusteringSessionId")
                        .HasDatabaseName("ix_clusters_clustering_session_id");

                    b.ToTable("clusters", (string)null);
                });

            modelBuilder.Entity("Medley.Domain.Entities.ClusteringSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_clustering_sessions");

                    b.ToTable("clustering_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    ...
                    b.Property<Vector>("ClusteringEmbedding")
                        .HasColumnType("vector(2000)")
                        .HasColumnName("clustering_embedding");
                    ...
                    b.HasIndex("KnowledgeCategoryId")
                        .HasDatabaseName("ix_fragments_knowledge_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.FragmentKnowledgeUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_fragment_knowledge_units");

                    b.HasIndex("KnowledgeUnitId")
                        .HasDatabaseName("ix_fragment_knowledge_units_knowledge_unit_id");

                    b.HasIndex("FragmentId", "KnowledgeUnitId")
                        .IsUnique()
                        .HasDatabaseName("ix_fragment_knowledge_units_fragment_id_knowledge_unit_id");

                    b.ToTable("fragment_knowledge_units", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.KnowledgeCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Medley.Domain.Entities.KnowledgeUnit", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_knowledge_units");

                    b.HasIndex("KnowledgeCategoryId")
                        .HasDatabaseName("ix_knowledge_units_knowledge_category_id");

                    b.ToTable("knowledge_units", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<bool>("EnableArticleZendeskSync")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_article_zendesk_sync");
                    ...
                    b.Property<int>("RequiredReviewCount")
                        .HasColumnType("integer")
                        .HasColumnName("required_review_count");

                    b.Property<Guid?>("RequiredReviewerId")
                        .HasColumnType("uuid")
                        .HasColumnName("required_reviewer_id");
                    ...
                    b.HasIndex("RequiredReviewerId")
                        .HasDatabaseName("ix_organizations_required_reviewer_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.PlanKnowledgeUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_plan_knowledge_units");

                    b.HasIndex("KnowledgeUnitId")
                        .HasDatabaseName("ix_plan_knowledge_units_knowledge_unit_id");

                    b.HasIndex(new[] { "PlanId", "KnowledgeUnitId" }, "IX_PlanKnowledgeUnits_PlanId_KnowledgeUnitId")
                        .IsUnique()
                        .HasDatabaseName("ix_plan_knowledge_units_plan_id_knowledge_unit_id");

                    b.ToTable("plan_knowledge_units", (string)null);
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid?>("ReviewSuccessorId")
                        .HasColumnType("uuid")
                        .HasColumnName("review_successor_id");
                    ...
                    b.HasIndex("ReviewSuccessorId")
                        .HasDatabaseName("ix_asp_net_users_review_successor_id");
            ...
            modelBuilder.Entity("ArticleKnowledgeUnit", b =>
                {
                    b.HasOne("Medley.Domain.Entities.Article", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_article_knowledge_units_articles_articles_id");

                    b.HasOne("Medley.Domain.Entities.KnowledgeUnit", null)
                        .WithMany()
                        .HasForeignKey("KnowledgeUnitsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_knowledge_units_knowledge_units_knowledge_units_id");
                });

            modelBuilder.Entity("ClusterFragment", b =>
                {
                    b.HasOne("Medley.Domain.Entities.Cluster", null)
                        .WithMany()
                        .HasForeignKey("ClustersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_cluster_fragment_clusters_clusters_id");

                    b.HasOne("Medley.Domain.Entities.Fragment", null)
                        .WithMany()
                        .HasForeignKey("FragmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_cluster_fragment_fragments_fragments_id");
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.AiPrompt", b =>
                {
                    ...
                    b.HasOne("Medley.Domain.Entities.KnowledgeCategory", "KnowledgeCategory")
                        .WithMany()
                        .HasForeignKey("KnowledgeCategoryId")
                        .HasConstraintName("fk_ai_prompts_knowledge_categories_knowledge_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasOne("Medley.Domain.Entities.Plan", "CurrentPlan")
                        .WithOne()
                        .HasForeignKey("Medley.Domain.Entities.Article", "CurrentPlanId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_articles_plans_current_plan_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.ArticleReview", b =>
                {
                    b.HasOne("Medley.Domain.Entities.Article", "Article")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_reviews_articles_article_id");
                    ...
                    b.HasOne("Medley.Domain.Entities.User", "ReviewedBy")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_article_reviews_users_reviewed_by_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Cluster", b =>
                {
                    b.HasOne("Medley.Domain.Entities.ClusteringSession", "ClusteringSession")
                        .WithMany("Clusters")
                        .HasForeignKey("ClusteringSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clusters_clustering_sessions_clustering_session_id");

                    b.Navigation("ClusteringSession");
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    b.HasOne("Medley.Domain.Entities.KnowledgeCategory", "KnowledgeCategory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fragments_knowledge_categories_knowledge_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.FragmentKnowledgeUnit", b =>
                {
                    b.HasOne("Medley.Domain.Entities.Fragment", "Fragment")
                        .WithMany("FragmentKnowledgeUnits")
                        .HasForeignKey("FragmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fragment_knowledge_units_fragments_fragment_id");

                    b.HasOne("Medley.Domain.Entities.KnowledgeUnit", "KnowledgeUnit")
                        .WithMany("FragmentKnowledgeUnits")
                        .HasForeignKey("KnowledgeUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fragment_knowledge_units_knowledge_units_knowledge_unit_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.KnowledgeUnit", b =>
                {
                    b.HasOne("Medley.Domain.Entities.KnowledgeCategory", "Category")
                        .WithMany()
                        .HasForeignKey("KnowledgeCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_knowledge_units_knowledge_categories_knowledge_category_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Organization", b =>
                {
                    b.HasOne("Medley.Domain.Entities.User", "RequiredReviewer")
                        .WithMany()
                        .HasForeignKey("RequiredReviewerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_organizations_users_required_reviewer_id");

                    b.Navigation("RequiredReviewer");
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.PlanKnowledgeUnit", b =>
                {
                    b.HasOne("Medley.Domain.Entities.KnowledgeUnit", "KnowledgeUnit")
                        .WithMany("PlanKnowledgeUnits")
                        .HasForeignKey("KnowledgeUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_plan_knowledge_units_knowledge_units_knowledge_unit_id");
                    ...
                    b.HasOne("Medley.Domain.Entities.Plan", "Plan")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_knowledge_units_plans_plan_id");
            ...
            modelBuilder.Entity("Medley.Domain.Entities.User", b =>
                {
                    b.HasOne("Medley.Domain.Entities.User", "ReviewSuccessor")
                        .WithMany()
                        .HasForeignKey("ReviewSuccessorId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_asp_net_users_asp_net_users_review_successor_id");

                    b.Navigation("ReviewSuccessor");
                });
            ...
            modelBuilder.Entity("Medley.Domain.Entities.Fragment", b =>
                {
                    b.Navigation("FragmentKnowledgeUnits");
                });
