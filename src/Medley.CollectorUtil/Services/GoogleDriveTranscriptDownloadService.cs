...
/// </summary>
public class GoogleDriveTranscriptDownloadService
{
    private readonly GoogleDriveApiService _driveApiService;
    private readonly GoogleMeetTranscriptDownloader _transcriptDownloader;
    private readonly MeetingTranscriptService _transcriptService;

    public GoogleDriveTranscriptDownloadService(
        GoogleDriveApiService driveApiService,
        GoogleMeetTranscriptDownloader transcriptDownloader,
